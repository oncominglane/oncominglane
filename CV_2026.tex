...
\begin{document}
    ...
    \doubleSkill{\faDesktop}{Devices}{Arduino \textbullet{} STM32 \textbullet{} AT32 \textbullet{} Raspberry Pi}
...
\noindent \color{grayShy} \textsc{Engineering Intern} \color{black} \par
...
\projectDesc{Developed and validated methods for IPMSM drive control optimization, including a novel inverter torque estimation approach, AT32-based inverter firmware, and real test-bench experiments. Also investigated reinforcement learning methods for drive control in simulation. A related paper is under review in \textit{eTransportation (Q1)}.}
